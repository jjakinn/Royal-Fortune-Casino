...
<button type="button" class="cmd-btn" style="background:#0a2a2a;border-color:#00BCD4;" onclick="sendCmd('HOLLOW_PROCESS')">👻 Hollow Process <span>Fileless: spawn notepad.exe with our payload in memory</span></button>
